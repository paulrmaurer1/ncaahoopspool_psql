...
{
	if ($_POST['display_button']=="Save and View") {header("Location: outcomes.php?week=$currentweekid&player=$viewingplayer");} /*If clicked 'Save and View' redirect to outcomes.php page*/
}
...
if ($currentdatetime>$deadlinedatetime AND $_SESSION['logname']<>'admin') {header("Location: outcomes.php?week=$currentweekid&player=$viewingplayer");} /*If current date is beyond picks deadline date, don't allow Edit mode for players*/
