...
<form action="roster.php" method='POST'>
	<?php
	if($_SESSION['logname']=='admin') {include_once("includes/displayrosterform.inc");} /*display roster entry form for admin user*/
	include_once("includes/displayroster.inc"); /*display roster below form*/
	?>
</form><br/><br/>
