...
if (isset($_POST['selections']))
{
	...
	$result=pg_exec($cxn,$query) or die ("Could not execute gamedate update query");
        if ($selects['locale']<>0) {$gamecounter=$gamecounter+1;}
        /*echo "success</br>";*/
    }
    ...
    if ($_POST['display_button']=="Save and View") {header("Location: winners.php?week=$currentweekid");} /*If click 'Save & View' redirect back to winners.php page*/
